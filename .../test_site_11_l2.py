...
Automated Remote Site Test Script - Site Type 11 - Layer 2

USAGE: pytest --disable-warnings -v test_site_11_l2.py --deviceId 100.113.8.1
...
def test_omp_remote(deviceId):
    response = runner.invoke(device, ['--omp', '100.113.1.1', 'summary' ])
    assert response.exit_code == 0
